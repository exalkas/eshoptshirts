...
import PaypalExpressBtn from 'react-paypal-express-checkout'; //paypal connector
...
class Paypal extends Component {
    render() {
        ...
        const onSuccess = (payment) =>{ 
            ...
            this.props.onSuccess(payment); //calls the parent method transactionSuccess


            //FOR REFERENCE, WHAT PAYPAL RETURNS BACK
            // { 
            //     "paid": true, 
            //     "cancelled": false, 
        ...
        return (
            <div>
                <PaypalExpressBtn
                    ...
                    client={client} //the var from above
                    currency={currency}//...
                    total={total}//...
                    onError={onError} //from parent
                    onSuccess={onSuccess} //from parent
                    onCancel={onCancel} //from parent
                    style={{ //change the style here
                        size:'large',
                        color: 'blue',
                        shape: 'rect',
                        label: 'checkout'
